 /*--------------------------------------------------------------------------++
||    DD_P6_12 (both lights on + large reward + with Forced Choice Trials)    ||
++---------------------------------------------------------------------------*/
...
String paradigm = "DD_P6_12_ll_vf";  // ll = left large (left port is the large reward port)
...
void loop() {
    ...
    if (current_port == 1) {  // a FC trial with left port LED on (large reward) 
      // delay(1);
      activate_left_led();
      activate_left_sol();
      }

    else if (current_port == 2) {  // a FC trial with right port LED on (small reward) 
      // delay(1);
      activate_right_led();
      activate_right_sol();
      }
      
    else if (current_port > 2) {  // a free choice P6_2 trial with both port LEDs on 
      // delay(1);
      activate_middle_led();
      activate_middle_sol();
      } 
