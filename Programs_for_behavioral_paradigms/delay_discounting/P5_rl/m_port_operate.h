...
void activate_middle_sol () {  // controls Reward Window functionality (reward cue presentation + reward delivery) 
    ...
    if (led_state_L == LOW) {
        ...
        if ((reward_window) && (reward_type == 1)) {
            ...
            Serial.print(F("81270:"));   // MIDDLE SOLENOID Timestamp for Free Choice Valid Solenoid 
           ...
           if (start_iti_window) {   // reset any port counters before ITI WINDOW starts (to count the pokes during the ITI window) 
