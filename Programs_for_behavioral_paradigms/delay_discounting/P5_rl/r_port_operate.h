...
void activate_right_led() {  // turn on right LED during trial window + turn off the LEDs after correct response 
     ...
     if (solenoid_active_M == false) {
       ...
       // (PORT LIGHT ON) Turn on Right LED if it is a valid trial
         ...
         // (INVALID_POKE - LIGHT OFF) --> poke in the unlit left or middle ports
