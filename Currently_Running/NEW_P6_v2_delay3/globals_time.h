...
//unsigned long iti_interval[NUM_TIMES] = {3000, 3200, 3400, 3700, 4000, 4500, 4700, 5000, 5100, 5500, 5700, 6000};
...
const int led_trial_duration = 1500;   // aka stimulus duration (SD)

const int delay_duration = 3000;     // CHANGE LATER
